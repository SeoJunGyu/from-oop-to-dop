...
public class SwordBuilder : MonoBehaviour
{
    ...
    {
        sword.AttackValue = UnityEngine.Random.Range(10, 101);
        return this;
    }

    public SwordBuilder SetRandomElementType()
    {
        sword.Type = (ElementType)UnityEngine.Random.Range(0, 5);
        return this;
    }

    public SwordBuilder SetRandomOption()
    {
        int randomIndex = UnityEngine.Random.Range(0, weaponOptions.Length);
        sword.Options.Add(weaponOptions[randomIndex]);
        return this;
    }

    //이건 쓰면 안되지만 편하기는 한 방법
